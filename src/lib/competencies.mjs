...
export const COMPETENCIES = Object.freeze([
  ...
  { id: 'attention_concentration', label: 'Atenção e Concentração', description: 'Capacidade de manter o foco, acompanhar informações e perceber elementos relevantes durante uma atividade.', examples: ['Memória', 'Observação', 'Precisão'], order: 2 },
...
export function migrateProfile(profile) {
  ...
  return { ...profile, objetivo: normalizeCompetencyId(profile.objetivo) };
}
